...
- ???Python 3.11.9: `python -m unittest discover -s tests -v` ? 14????
- Ubuntu????Python 3.10.12: ??venv? `requirements.txt` ???????14?????
- `scripts/copy-to-sandbox.ps1` ??Git????16??????? C:\project\ubuntu_sandbox\remote_agent_com_sys ????????Git?????????????????????
- Bot?AppServer??????????????Codex CLI 0.156.1?????????? `approvalPolicy=untrusted`?`approvalsReviewer=user`?`sandbox=readOnly`?`model=gpt-6-luna` ?????????
- Bot???????????????????????????????????????????????rollout???????????????????????????
- ?CLI????????? `approval_policy=untrusted` ????????????????????? `on-request`???????????? `untrusted` ??????CLI 0.156.1????????????????????????

## 2026-09-24: turn/start??CLI???

Ubuntu???Bot???????????turn/start???Codex CLI 0.156.1???????ID?????????`readOnly.access`???????CLI????????`sandboxPolicy={type: readOnly}`???????????????Codex????????????????????????????????????Ubuntu??????14????

## ???

?Discord Bot???????????/?????/????ID???Codex??????????????????Discord?????????????????????????????PC?????????????????????????????????????????
